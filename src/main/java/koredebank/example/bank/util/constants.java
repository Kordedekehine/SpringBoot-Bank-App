package koredebank.example.bank.util;

import java.util.regex.Pattern;

public class constants {

    //THERE IS NOTHING LIKE SORTCODE IN MY BOOK
    ...
    public static final String INVALID_TRANSACTION = "Account information is invalid or transaction " +
            "has been denied for your protection. Please try again.";
